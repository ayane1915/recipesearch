    ...
    <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            ...
            `;
                    ...
                    // 新しく追加されたpointテキストエリアに自動リサイズ機能を追加
                    const newPointTextarea = stepDiv.querySelector('textarea[name="points"]');
                    if (newPointTextarea) {
                        newPointTextarea.addEventListener('input', function () {
                            autoResizeTextarea(this);
                        });
                        autoResizeTextarea(newPointTextarea);
                    }
                }
                ...
                window.addEventListener('DOMContentLoaded', function () {
                    ...
                    // 既存のpointテキストエリアに自動リサイズ機能を追加
                    const pointTextareas = document.querySelectorAll('textarea[name="points"]');
                    pointTextareas.forEach(function (textarea) {
        ...
        <body>
            ...
            <form action="/add" method="post">
                ...
                <div id="ingredients">
                    <div>
                        <label for="ingredientName">ing.</label> <input type="text" name="ingredientNames" required
